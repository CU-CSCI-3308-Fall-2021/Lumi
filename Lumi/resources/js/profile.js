function openModal() {
    ...
    myInput.onkeyup = function () {
      ...
      var numbers = /[1-2]/g; // : Fill in the regular experssion for digits
  ...
  function enableButton(letter, capital, number, length, match) {
    ...
    console.log(letter.classList.value === "valid" && capital.classList.value === "valid");
    var button = document.getElementById("my_submit_button");
    var condition = (letter.classList.value === "valid" && capital.classList.value === "valid" && capital.classList.value === "valid" && length.classList.value === "valid" && match.classList.value === "valid"); // TODO: Replace false with the correct condition
    if (condition == true) {
